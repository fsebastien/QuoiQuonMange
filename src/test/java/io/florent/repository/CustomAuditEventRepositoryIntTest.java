...
import io.florent.config.audit.AuditEventConverter;
import io.florent.domain.PersistentAuditEvent;
...
import static io.florent.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
